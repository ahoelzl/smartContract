...
// This is a simple game that can be played on the Ethereum blockchain.
// There are two teams, Red and Blue. Players can add money to the stack of Red or Blue and
// independently of which team gets money from the player, the player can bet which team wins.
