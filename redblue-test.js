...
contract('RedBlue', function(accounts) {
    ...
    it("correctly solve bets", async function() {
        ...
        var result = await meta.bet(0, 0, {
            from: accounts[0],
            value: web3.toWei(1, "ether")
        })
        var result2 = await meta.bet(1, 1, {
            from: accounts[1],
            value: web3.toWei(2, "ether")
        })
    ...
    it("correctly solve bets2", async function() {
        ...
        var result2 = await meta.bet(0, 0, {
            from: accounts[3],
    ...
    it("correctly solve bets minor wins betOther", async function() {
        ...
        var result = await meta.bet(1, 1, {
            from: accounts[0],
            value: web3.toWei(1, "ether")
        })
        var result2 = await meta.bet(0, 1, {
            from: accounts[1],
            value: web3.toWei(2, "ether")
        })
        var result2 = await meta.bet(0, 0, {
    ...
    it("correctly solve bets2", async function() {
        ...
        var result = await meta.bet(0, 0, {
            from: accounts[0],
            value: web3.toWei(r1 * 5, "ether")
        })
        var result2 = await meta.bet(1, 1, {
            from: accounts[1],
            value: web3.toWei(r2 * 5, "ether")
        })
        var result2 = await meta.bet(0, 0, {
            from: accounts[3],
            value: web3.toWei(r3 * 5, "ether")
        })
        var result2 = await meta.bet(0, 0, {
            from: accounts[4],
            value: web3.toWei(r4 * 5, "ether")
        })
        var result2 = await meta.bet(1, 1, {
            from: accounts[5],
            value: web3.toWei(r5 * 5, "ether")
        })
